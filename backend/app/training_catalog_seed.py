...
TRAINING_CONTEXTS = (
    ...
    (
        ...
        "OTHER",
        "HYROX SkiErg",
        "SkiErg station training for HYROX.",
    ),
    (
        "hyrox_sled_push_pull",
        "STRENGTH",
        "HYROX sled push and pull",
        "Sled push and sled pull station training for HYROX.",
    ),
    (
        "hyrox_burpee_broad_jump",
        "OTHER",
        "HYROX burpee broad jump",
        "Burpee broad-jump station training for HYROX.",
    ),
    (
        "hyrox_row",
        "OTHER",
        "HYROX rowing",
        "Rowing station training for HYROX.",
    ),
    (
        "hyrox_farmer_carry",
        "STRENGTH",
        "HYROX farmer carry",
        "Farmer-carry station training for HYROX.",
    ),
    (
        "hyrox_sandbag_lunge",
        "STRENGTH",
        "HYROX sandbag lunge",
        "Sandbag-lunge station training for HYROX.",
    ),
    (
        "hyrox_wall_balls",
        "STRENGTH",
        "HYROX wall balls",
        "Wall-ball station training for HYROX.",
    ),
    (
        "grip_training",
        "STRENGTH",
...
GOAL_CONTEXTS = (
    ...
    *(
    ...
    ("HYROX", "hyrox_ski_erg", "TARGET", 20),
    ("HYROX", "hyrox_sled_push_pull", "TARGET", 30),
    ("HYROX", "hyrox_burpee_broad_jump", "TARGET", 40),
    ("HYROX", "hyrox_row", "TARGET", 50),
    ("HYROX", "hyrox_farmer_carry", "TARGET", 60),
    ("HYROX", "hyrox_sandbag_lunge", "TARGET", 70),
    ("HYROX", "hyrox_wall_balls", "TARGET", 80),
...
EXECUTION_OPTIONS = (
    ...
    (
        "hyrox_sled_push_pull",
        "hyrox_sled_push_pull_execution",
        "HYROX sled push and pull",
        "hyrox_sled_push_pull",
        "PREFERRED",
        10,
    ...
    (
        "hyrox_burpee_broad_jump",
        "hyrox_burpee_broad_jump_execution",
        "HYROX burpee broad jump",
        "hyrox_burpee_broad_jump",
        "PREFERRED",
        10,
...
OPTION_CAPABILITIES = (
    ...
    *(
        (context, f"{context}_execution", "gym_access", "REQUIRED")
        for context in (
            "hyrox_ski_erg",
            "hyrox_sled_push_pull",
            "hyrox_burpee_broad_jump",
    ...
    ("hyrox_ski_erg", "hyrox_ski_erg_execution", "ski_ergometer", "REQUIRED"),
    (
        "hyrox_sled_push_pull",
        "hyrox_sled_push_pull_execution",
        "sled_push_pull_equipment",
    ...
    ("hyrox_row", "hyrox_row_execution", "rowing_ergometer", "REQUIRED"),
    (
        "hyrox_farmer_carry",
        "hyrox_farmer_carry_execution",
        "farmer_carry_weights",
