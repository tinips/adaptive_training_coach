"""Add a discoverable training-goal field menu.

Revision ID: 0020_add_goal_menu
Revises: 0019_expand_goal_settings
"""
...
revision: str = "0020_add_goal_menu"
down_revision: str | None = "0019_expand_goal_settings"
...
def downgrade() -> None:
    op.execute(
        sa.text(
            ...
            "pending_answers = '{}' WHERE current_step = 'GOAL_MENU'"
        )
    )
